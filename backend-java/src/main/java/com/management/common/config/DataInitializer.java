...
public class DataInitializer implements ApplicationRunner {
    ...
    private void initDefaultWorkflowRules() {
        ...
        List<WorkflowRule> rules = List.of(
            ...
            rule("task", "dev_lead",    "testing",     "closed"),
            rule("task", "dev_lead",    "testing",     "developing"),
            rule("task", "dev",         "pending",     "developing"),
            rule("task", "dev",         "developing",  "testing"),
            rule("task", "dev",         "testing",     "closed"),
            ...
            rule("bug", "tester",    "not_a_bug", "unfixed"),
            rule("bug", "tester",    "not_a_bug", "closed"),
            rule("bug", "pm",        "fixed",     "unfixed"),
            rule("bug", "pm",        "fixed",     "closed"),
            rule("bug", "pm",        "not_a_bug", "unfixed"),
            rule("bug", "pm",        "not_a_bug", "closed"),
            rule("bug", "dev",       "unfixed",   "fixed"),
            rule("bug", "dev",       "unfixed",   "not_a_bug"),
            rule("bug", "dev",       "fixed",     "unfixed"),
            rule("bug", "dev",       "fixed",     "closed"),
            rule("bug", "dev",       "not_a_bug", "unfixed"),
            rule("bug", "dev",       "not_a_bug", "closed"),
            rule("bug", "dev_lead",  "unfixed",   "fixed"),
            rule("bug", "dev_lead",  "unfixed",   "not_a_bug"),
            rule("bug", "dev_lead",  "fixed",     "unfixed"),
            rule("bug", "dev_lead",  "fixed",     "closed"),
            rule("bug", "dev_lead",  "not_a_bug", "unfixed"),
            rule("bug", "dev_lead",  "not_a_bug", "closed"),
